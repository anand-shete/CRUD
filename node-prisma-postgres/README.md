...
### Trying to build a simple CRUD application using following stack

**Node.js**: Server runtime for javscript.  
 ...
 **AWS**: Integrating AWS RDS service into the CRUD application.
